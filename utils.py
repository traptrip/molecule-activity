...
def graph_features_from_smiles(smiles_list, atom_featurizer, bond_featurizer):
    # Initialize graphs
    atom_features_list = []
    bond_features_list = []
    ...
    max_len = len(max(atom_features_list, key=len))

    return atom_features_list, bond_features_list
